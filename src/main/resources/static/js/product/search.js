...
const saveword = document.getElementById("save_word");

let checkML = 0; // 카테고리에 설정될 ML 변수
let checkPrice = 'null'; // 카테고리에 설정될 가격순 변수

const perfumeWord = saveword.value; // 보고있는 페이지의 검색어 저장
...
function create_products(object){
    ...
    const perfumePriceText = object.perfumePrice.toLocaleString();
